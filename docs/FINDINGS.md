...
- [`mtp_v03_bf16_block_bisection.md`](findings/mtp_v03_bf16_block_bisection.md) — v0.3 re-conversion with entire `mtp.0.*` as BF16 (matches V4-Flash recipe). Result: 3.33% — falsifies the "NVFP4 mtp experts cause the gap" hypothesis. Remaining suspect: trunk NVFP4 quantization shifts the activation distribution flowing into the MTP head.
