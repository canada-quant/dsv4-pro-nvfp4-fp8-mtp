...
- [`mtp_v05_full_unquant_breakthrough.md`](findings/mtp_v05_full_unquant_breakthrough.md) — v0.4-bisect (MXFP4-passthrough trunk + BF16 mtp.0) on our build: **2.65%**. Identical to v0.2/v0.3 → rules out trunk format and mtp.0 format entirely. Bug is in mainline vLLM's MTP forward path between Apr 25 and May 22 (suspected: `MHCFusedPostPreOp` + `NormGatedLinear` refactor). Filed as [vLLM #43472](https://github.com/vllm-project/vllm/issues/43472).
